...
I have recently been getting into all things [Docker](https://www.docker.com/) and more specifically [Docker Swarm](https://docs.docker.com/engine/swarm/), which is ironic because https://www.theregister.co.uk/2019/11/13/docker_enterprise_miranits/


One thing I soon discovered is that Docker Swarm is excellent at keeping containers up and running, but does nothing for persistent storage. 

[useful](https://theworkaround.com/2019/05/15/docker-swarm-persistent-storage.html)
